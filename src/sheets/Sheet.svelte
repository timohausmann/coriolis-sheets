    ...
    <div class="container">
      {#if noData}
        <div class="notification is-info is-light">
          <strong>Note:</strong> you need to be logged in to save the sheet.
        </div>
      {:else}
        <div class="level">
          ...
          {#if charData.owner === userId}
            <div class="buttons">
              <button class="button is-primary" type="submit" on:click={save} disabled={!$unsavedChangesStore}
                ><span class="icon is-small"><i class="fa fa-save" /></span> <span>{$_("save")}</span></button
              >
              <Dropdown
                options={[
                  {
